...
<%@ include file="/admin/include/check_admin.jsp" %>
	<div id="subTitle">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="sub_title" width="100%" height="35" align="center"><span id="subTitleView" style="display:block;">사이트관리</span></td>
	...
	<div id="subList" style="display:block;">
		<ul>
			<li><a href="javascript:menu01_sub01()">사이트정보</a></li>
			<li><a href="javascript:menu01_sub02()">운영정보</a></li>
		</ul>
	</div>