...
<body>
	<div id="conTents">
		<form name="wForm" method="post" action="add_ok.jsp" enctype="multipart/form-data">
			<%=function.getTitleBox(ADMIN_IMG, "POPUP 추가")%>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="t_b_bottom">
				...
				<!-- 
				<tr>
					<td width="13%" class="t_thC">팝업크기</td>
					<td width="" class="t_tdL" valign="middle">
						WIDTH : <input class="input" type="text" name="win_width" size="9" value="0">
						&nbsp;
						HEIGHT : <input class="input" type="text" name="win_height" size="9" value="0">
					</td>
				</tr>
				 -->
				<tr>
					...
					<td width="" class="t_tdL" valign="middle">
						TOP : <input class="input" type="text" name="win_top" size="9" value="0">
						&nbsp;
						LEFT : <input class="input" type="text" name="win_left" size="9" value="0">
					</td>
				</tr>
				<tr>
					<td width="13%" class="t_thC">LINK URL</td>
					<td width="" class="t_tdL" valign="middle">
						http://<input class="input" type="text" name="link_url" style="width:60%">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="" class="t_tdL">
						<input class="input" type="text" name="start_date" style="width:20%;cursor:pointer" readonly="readonly" onClick="javascript:Calendar(this, event);">
					</td>
				</tr>
				<tr>
					<td width="13%" class="t_thC">종료일</td>
					<td width="" class="t_tdL">
						<input class="input" type="text" name="end_date" style="width:20%;cursor:pointer" readonly="readonly" onClick="javascript:Calendar(this, event);">
					</td>
				</tr>
			</table>
			<!-- 버튼 -->
