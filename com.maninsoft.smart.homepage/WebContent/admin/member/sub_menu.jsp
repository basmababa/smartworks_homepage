...
<%@ include file="/admin/include/check_admin.jsp" %>
	<div id="subTitle">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="sub_title" width="100%" height="35" align="center"><span id="subTitleView" style="display:block;">회원관리</span></td>
	...
	<div id="subList" style="display:block;">
		<ul>
			<li><a href="javascript:menu02_sub01()">권한관리</a></li>
			<li><a href="javascript:menu02_sub02()">회원관리</a></li>
			<li><a href="javascript:menu02_sub03()">메일발송</a></li>
		</ul>
	</div>