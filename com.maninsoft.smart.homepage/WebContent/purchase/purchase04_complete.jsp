			...
			<div id="mainwrap">
				...
				<div id="contents">
					<table width="770" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td><img src="<%=IMG_ROOT%>/purchase_title2.jpg" width="769" height="86"></td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							<td><img src="<%=IMG_ROOT%>/purchase_stitle_04.jpg" alt="" width="308" height="21"></td>
						</tr>
						<tr>
							<td height="20">&nbsp;</td>
						</tr>
						<tr>
							<td align="center"><img src="<%=IMG_ROOT%>/demoinfo_thankyou.jpg" width="603" height="324"></td>
						</tr>
					</table>
				</div>
				<div id="right">
