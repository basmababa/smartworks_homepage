...
<script language="javascript" type="text/javascript">
	function goDemo() {
		...
		if (document.demoForm.agreement[1].checked) {
			alert("이용약관에 동의하셔야 체험시스템신청이 가능합니다.");
			document.demoForm.agreement[0].focus();
			return;
		}

		if (document.demoForm.privacy[1].checked) {
			alert("개인정보취급방침에 동의하셔야 체험시스템신청이 가능합니다.");
			document.demoForm.privacy[0].focus();
			return;
		}

		if(checkForm(document.demoForm.company, "회사명")) return;
		if(checkForm(document.demoForm.name, "담당자")) return;
		if(checkForm(document.demoForm.email, "이메일")) return;
		if(!isEMail(document.demoForm.email)) return;
		if(checkForm(document.demoForm.hp, "연락처")) return;
		if(checkForm(document.demoForm.staff_number, "직원수")) return;
		if(isNumber(document.demoForm.staff_number, "직원수")) return;
		if(checkForm(document.demoForm.user_number, "사용자수")) return;
		if(isNumber(document.demoForm.user_number, "사용자수")) return;
		if(checkForm(document.demoForm.item, "업종")) return;
		if(checkForm(document.demoForm.business, "업태")) return;
	...
	<div id="cbody">
		<div id="wrap">
			...
			<div id="mainwrap">
				...
				<div id="contents">
					<form name="demoForm" method="post" action="purchase04_ok.jsp">
						<table width="770" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td colspan="2"><img src="<%=IMG_ROOT%>/purchase_stitle_04.jpg" width="287" height="18" alt="체험시스템 신청"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="739" height="85" valign="top"><img src="<%=IMG_ROOT %>/purchase_tt_02_d000.jpg"></td>
							</tr>
							<%--
							<tr>
								<td width="31" rowspan="15">&nbsp;</td>
								<td width="739"><img src="<%=IMG_ROOT%>/purchase_dtt_01_001.jpg" alt=""></td>
							</tr>
							<tr>
								<td height="5"></td>
							</tr>
							...
							--%>
							<tr>
								<td align="left"><img src="<%=IMG_ROOT%>/purchase_dtt_01_002.jpg" alt=""></td>
							</tr>
							<tr>
								<td align="center"><img src="<%=IMG_ROOT%>/purchase_demo_01.jpg" alt=""></td>
							</tr>
							<tr>
								<td align="center">&nbsp;</td>
							</tr>
							<tr>
								<td><img src="<%=IMG_ROOT%>/purchase_demo_02.jpg" alt=""></td>
							</tr>
							<tr>
