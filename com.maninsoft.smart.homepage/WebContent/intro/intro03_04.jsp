...
<%
	String PAGE_INFO = "menu01_sub03_04";
%>
		...
		<div id="wrap">
			...
			<div id="mainwrap">
				...
				<div id="contents">
							...
							<td width="739" align="left">
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td width="610" height="33" valign="bottom"><img id="intro_03_04" src="<%=IMG_ROOT%>/intro_003_f04.jpg" width="572" height="33" alt="" onmouseover="MM_swapImage('intro_03_04','','<%=IMG_ROOT%>/intro_003_f04.jpg',1)" onmouseout="MM_swapImgRestore()" onclick="sti03_04()" style="cursor:pointer;"></td>
									</tr>
									<tr>
					...
					<div id="info03_04" style="position:relative; display:block">
						<table width="703" height="61" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
							...
							<tr>
								...
								<td> 업무 앱스토어를 통하여 인터넷이 가능한 어느곳에서도 필요업무를 검색, 다운로드 및 시스템 배치.적용이 가능합니다.</td>
							</tr>
							<tr>
