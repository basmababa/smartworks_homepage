...
<%
	String PAGE_INFO = "menu01_sub03_05";
%>
		...
		<div id="wrap">
			...
			<div id="mainwrap">
				...
				<div id="contents">
						...
						<tr>
							...
							<td width="739" align="left">
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td valign="top"><img id="intro_03_05" src="<%=IMG_ROOT%>/intro_003_f05.jpg" width="572" height="30" alt="" onmouseover="MM_swapImage('intro_03_05','','<%=IMG_ROOT%>/intro_003_f05.jpg',1)" onmouseout="MM_swapImgRestore()" onclick="sti03_05()" style="cursor:pointer;"></td>
									</tr>
									<tr>
					...
					<div id="info03_05" style="position:relative; display:block">
						<table width="703" height="61" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
							...
							<tr>
								...
								<td> 파워포인트, 워드를 사용하듯 편하게 코딩없이 업무를 직접 만들어 쓸 수 있습니다.</td>
							</tr>
							<tr>
