...
<%
	String PAGE_INFO = "menu01_sub03_07";
%>
		...
		<div id="wrap">
			...
			<div id="mainwrap">
				...
				<div id="contents">
						...
						<tr>
							...
							<td width="739" align="left">
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td><img id="intro_03_07" src="<%=IMG_ROOT%>/intro_003_f07.jpg" width="572" height="27" alt="" onmouseover="MM_swapImage('intro_03_07','','<%=IMG_ROOT%>/intro_003_f07.jpg',1)" onmouseout="MM_swapImgRestore()" onclick="sti03_07()" style="cursor:pointer;"></td>
									</tr>
									<tr>
					...
					<div id="info03_07" style="position:relative; display:block">
