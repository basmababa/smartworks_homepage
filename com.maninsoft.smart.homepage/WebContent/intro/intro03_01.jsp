...
<%
	String PAGE_INFO = "menu01_sub03_01";
%>
							...
							<td width="739" align="left">
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="610"><img id="intro_03_01" src="<%=IMG_ROOT%>/intro_003_f01.jpg" width="572" height="32" alt="" onmouseover="MM_swapImage('intro_03_01','','<%=IMG_ROOT%>/intro_003_f01.jpg',1)" onmouseout="MM_swapImgRestore()" onclick="sti03_01()" style="cursor:pointer;"></td>
									</tr>
									<tr>
					...
					<div id="info03_01" style="position:relative; display:block">
						<table width="703" height="61" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
							...
							<tr>
								...
								<td>스마트웍스닷넷은 프로세스맵 기능을 제공하여 업무처리 및 진행현황, 업무의 역할과 책임을 쉽게 파악할 수 있습니다.</td>
							</tr>
							<tr>
