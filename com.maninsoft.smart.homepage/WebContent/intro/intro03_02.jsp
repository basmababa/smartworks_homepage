...
<%
	String PAGE_INFO = "menu01_sub03_02";
%>
		...
		<div id="wrap">
			...
			<div id="mainwrap">
				...
				<div id="contents">
						...
						<tr>
							...
							<td width="739" align="left">
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td><img id="intro_03_02" src="<%=IMG_ROOT%>/intro_003_f02.jpg" width="572" height="29" alt="" onmouseover="MM_swapImage('intro_03_02','','<%=IMG_ROOT%>/intro_003_f02.jpg',1)" onmouseout="MM_swapImgRestore()" onclick="sti03_02()" style="cursor:pointer;"></td>
									</tr>
									<tr>
					...
					<div id="info03_02" style="position:relative; display:block">
						<table width="703" height="61" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
							...
							<tr>
								...
								<td width="650"> 업무들을 매뉴얼화하고 정해진 절차에 의해 처리되도록 업무 처리 절차를 자동화하여 업무 처리 오류를 사전에 방지</td>
							</tr>
							<tr>
