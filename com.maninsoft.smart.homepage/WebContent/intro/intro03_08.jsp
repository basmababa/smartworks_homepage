...
<%
	String PAGE_INFO = "menu01_sub03_08";
%>
		...
		<div id="wrap">
			...
			<div id="mainwrap">
				...
				<div id="contents">
						...
						<tr>
							...
							<td width="739" align="left">
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td valign="top"><img id="intro_03_08" src="<%=IMG_ROOT%>/intro_003_f08.jpg" width="572" height="27" alt="" onmouseover="MM_swapImage('intro_03_08','','<%=IMG_ROOT%>/intro_003_f08.jpg',1)" onmouseout="MM_swapImgRestore()" onclick="sti03_08()" style="cursor:pointer;"></td>
									</tr>
								</table>
							</td>
						</tr>
					...
					<div id="info03_08" style="position:relative; display:block">
						<table width="703" height="61" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
							...
							<tr>
								...
								<td> 업무앱스토어에서 다운 받은 업무들과 빌더를 통해 생성된 업무들은 스마트웍스 업무관리소에서 바로 실행 및 배치하여 사용할 수 있습니다.</td>
							</tr>
							<tr>
