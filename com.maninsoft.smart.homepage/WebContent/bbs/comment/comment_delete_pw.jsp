...
<body>
	<div id="id_check" class="darkborder_dropS">
		<form name="passForm" method="post" action="" onsubmit="return false;">
			<fieldset>
				<legend>Comment Password Check Form</legend>
				<div id="info" class="darkborder">
					<div class="info_title" onmousedown="initializedrag('dialoglayer', event)" style="cursor:pointer;">Comment Password Check</div>
					<div class="info_sub">
						<span style="font-weight:bold;">패스워드</span>
						<span><input type="password" class="input" name="commentPass" onKeyPress="cmt_check_delete_password(event);"></span>
						<div id="button" class="right">
							<input type="button" class="dark_btn" value=" 삭 제 " onclick="cmt_delete_password();" style="cursor:pointer;">
