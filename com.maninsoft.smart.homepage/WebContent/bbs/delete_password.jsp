			...
			<fieldset>
				...
				<div id="info" class="darkborder">
					...
					<div class="info_sub">
						...
						<span><input type="password" class="input" name="bbsPass" onKeyPress="check_delete_password(event);"></span>
						<div id="button" class="right">
							<input type="button" class="dark_btn" value=" 삭 제 " onclick="delete_password();" style="cursor:pointer;">
