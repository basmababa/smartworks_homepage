...
<%
	String PAGE_INFO = "menu02_sub04_02";
%>
			...
			<div id="mainwrap">
				...
				<div id="contents">
					<table width="770" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="2"><img src="<%=IMG_ROOT%>/function_stitle_04_002.jpg" width="295" height="18" alt="업무 관리소 (프로세스빌더 화면)"></td>
						</tr>
						<tr>
							...
							<td width="739">
								<table width="710" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td> 프로세스업무를 만들고 편집하는 프로세스빌더 편집창에서는 편집 메뉴인 <strong>프로세스빌더 툴바</strong>를 볼 수 있습니다.</td>
									</tr>
								</table>
							</td>
						</tr>
								...
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="686" align="left">
											<img src="<%=IMG_ROOT%>/function_tt_04_002.jpg" width="110" height="26" alt="" align="top">
						...
						<tr>
							<td align="center">
								<script type="text/javascript">
									...
									voEmbed.init("flash", "<%=SWF_ROOT%>/function_004_02.swf", "654", "631");
