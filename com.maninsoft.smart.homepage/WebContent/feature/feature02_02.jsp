...
<%
	String PAGE_INFO = "menu02_sub02_02";
%>
			...
			<div id="mainwrap">
				...
				<div id="contents">
					<table width="770" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="2"><img src="<%=IMG_ROOT%>/function_stitle_02_002.jpg" width="295" height="18" alt="앱스토어 (상세화면)"></td>
						</tr>
						<tr>
						    	...
						    	<table width="700" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="686" align="left">
											<img src="<%=IMG_ROOT%>/function_tt_02_002.jpg" width="70" height="26" alt="" align="top">
						...
						<tr>
						    <td align="center">
						    	<script type="text/javascript">
									...
									voEmbed.init("flash", "<%=SWF_ROOT%>/function_002_02.swf", "654", "572");
